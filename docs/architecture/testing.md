...
The ratio falls out of the cost structure: most tests are unit, some are integration, a handful are end-to-end. A suite with 800 E2E tests isn't thorough, it's slow. Slowness is the start of a death spiral where tests stop being run.
