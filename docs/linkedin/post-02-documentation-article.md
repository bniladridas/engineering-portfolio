...
status: published
topic: documentation
hook: "Documentation is not the chore that follows the real work. It is the real work, in a form other people can use."
---

Documentation is not the chore that follows the real work. It is the real work, in a form other people can use.

Code records *what* happened. Docs record *why*. Without the why, every future change is archaeology.
