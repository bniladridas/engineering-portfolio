...
slug: post-xx-short-title
date: 2026-01-01
status: draft
topic: topic
hook: The single line that stops the scroll.
---

**How to use this template:** copy into `docs/linkedin/`, number the file sequentially, fill in the fields, and keep the post under ~200 words. A hook that stops the scroll, a body with one idea, and a call to action.
